...
## 🛠️ MCP Tools Suite (12 Official Tools)

When connected to **Claude Desktop**, **Antigravity**, or **Claude Web**, OpenFinder exposes 12 production tools:

| Tool Name | Parameters | Description |
| :--- | :--- | :--- |
| `linkedin_resume_match` | `candidate_profile_id`, `location`, `timeframe`, `max_results`, `min_match_score`, `remote_only` | 🆕 **LinkedIn-Session-Exclusive, Resume-Mandatory Search**: Fetches ONLY live authenticated LinkedIn `/posts/` — no curated repo, no search engine fallbacks. Ranks by 6-factor ATS match score from your uploaded resume. Each result includes matched skills, missing skills, projected score if upskilled, and auto-generated outreach pitches. |
