...
class OutreachPitchGenerator:
    ...
    def generate_suite(
        ...
        connection_note = (
            f"Hi! Noticed your opening for {job_title} at {company_name}. "
        ...
        linkedin_dm = (
            ...
            f"I saw your recent LinkedIn post regarding the {job_title} opportunity at {company_name}. "
        ...
        formal_email = (
            ...
            f"reliable, production-grade solutions with a strong emphasis on scalable architecture and user experience.\n\n"
            f"Key strengths I bring to {company_name}:\n"
            f"• Proficiency across {skills_str} and modern development best practices.\n"
